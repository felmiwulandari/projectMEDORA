...
@section('content', 'Login Page - Medora')
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" id="password" 
                                            class="form-control form-control-user rounded shadow-sm @error('password')
                                            is-invalid @enderror" style="border-width: 2px;" value="{{ old('password') }}" placeholder="Enter Your Password...">
